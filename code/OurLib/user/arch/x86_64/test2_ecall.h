...
extern int ecall_register_test_syscall_args(int did);
extern int ecall_register_test_syscall_function_args(int did);
...
extern int      ecall_test_syscall_args(void);
extern int      ecall_test_syscall_function_args(void);
